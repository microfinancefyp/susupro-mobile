...
class _CustomerProfileState extends State<CustomerProfile>
  ...
  void _initializeControllers() {
    ...
    _idCardController = TextEditingController(text: _currentCustomer.idCard ?? '');
        ...
        children: [
          ...
          _isEditing
              ? _buildEditableField(
                  ...
                  Icons.credit_card,
                  validator: (value) =>
                      value?.isEmpty ?? true ? 'ID Card is required' : null,
                )
              : 
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          20.0.vSpace,
          _buildInfoRow("Account Number", widget?.customer?.accountNumber ?? 'Unknown', Icons.account_box),
          16.0.vSpace,
